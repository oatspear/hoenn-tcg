...
DEF DUELVARS_ARENA_CARD_ATTACHED_WALLYS_TRAINING     EQUS "LOW(wPlayerArenaCardAttachedDefender)"   ; da
DEF DUELVARS_BENCH1_CARD_ATTACHED_WALLYS_TRAINING    EQUS "LOW(wPlayerBench1CardAttachedDefender)"  ; db
DEF DUELVARS_BENCH2_CARD_ATTACHED_WALLYS_TRAINING    EQUS "LOW(wPlayerBench2CardAttachedDefender)"  ; dc
DEF DUELVARS_BENCH3_CARD_ATTACHED_WALLYS_TRAINING    EQUS "LOW(wPlayerBench3CardAttachedDefender)"  ; dd
DEF DUELVARS_BENCH4_CARD_ATTACHED_WALLYS_TRAINING    EQUS "LOW(wPlayerBench4CardAttachedDefender)"  ; de
DEF DUELVARS_BENCH5_CARD_ATTACHED_WALLYS_TRAINING    EQUS "LOW(wPlayerBench5CardAttachedDefender)"  ; df
DEF DUELVARS_ARENA_CARD_ATTACHED_TV_REPORTER    EQUS "LOW(wPlayerArenaCardAttachedPluspower)"  ; e0
DEF DUELVARS_BENCH1_CARD_ATTACHED_TV_REPORTER   EQUS "LOW(wPlayerBench1CardAttachedPluspower)" ; e1
DEF DUELVARS_BENCH2_CARD_ATTACHED_TV_REPORTER   EQUS "LOW(wPlayerBench2CardAttachedPluspower)" ; e2
DEF DUELVARS_BENCH3_CARD_ATTACHED_TV_REPORTER   EQUS "LOW(wPlayerBench3CardAttachedPluspower)" ; e3
DEF DUELVARS_BENCH4_CARD_ATTACHED_TV_REPORTER   EQUS "LOW(wPlayerBench4CardAttachedPluspower)" ; e4
DEF DUELVARS_BENCH5_CARD_ATTACHED_TV_REPORTER   EQUS "LOW(wPlayerBench5CardAttachedPluspower)" ; e5
...
; constants for PracticeDuelActionTable entries
	...
	const PRACTICEDUEL_PUT_ARON_IN_BENCH
	...
	const PRACTICEDUEL_PLAY_ARON_FROM_BENCH
...
; wAlreadyDidUniqueAction constants
DEF PLAYED_ENERGY_THIS_TURN_F    EQU 0
DEF RETREATED_THIS_TURN_F        EQU 4

DEF PLAYED_ENERGY_THIS_TURN    EQU 1 << PLAYED_ENERGY_THIS_TURN_F
DEF RETREATED_THIS_TURN        EQU 1 << RETREATED_THIS_TURN_F
