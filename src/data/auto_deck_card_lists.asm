...
BenchAttackCardList:
	...
	card_item VOLTORB,           4
	card_item MAKUHITA,    2
	card_item TRAPINCH,       2
	card_item GROUDON,         4
	card_item RALTS,        2
	card_item SWALOT,       4
	card_item PROFESSOR_BIRCH,     1
	card_item ACRO_BIKE,              2
	card_item MR_STONES_PROJECT,           1
	card_item MAXIE,  2
	card_item SWITCH,            2
...
PokemonFluteCardList:
	...
	card_item ENERGY_SWITCH,      4
	card_item VS_SEEKER,     4
	deck_list_end
...
LovelyNidoranCardList:
	...
	card_item SHROOMISH,          3
	card_item NINCADA,         2
	card_item NINJASK,          4
	card_item SHEDINJA,          4
	card_item LATIOS,          4
	card_item WEEZING,         3
	card_item PROFESSOR_BIRCH,     2
